...
print("Full form of HTTPS")
print("\n1.Hyper Text Transfer Protocol Secure")
print("\n2.Hyper Text Transfer Protocol Server")
print("\n3.Hyper Text Transfer Power Server")
print("\n4.Hyper Text Train Power Simulation")
...
print("\n2.Server master title protocol")
print("\n3.Sound and mail transfer protocol")
print("\n4.Server mail title protocol")
print("\nPlease enter your answer in single digit")
x=input()
if x == "1":
	ans=ans+1
